...
public class WorkerRunnableSNLDA implements Runnable {
	...
	protected void sampleTopicsForOneDoc (FeatureSequence tokenSequence,
		...
		for (int position = 0; position < docLength; position++) {
			if (oneDocTopics[position] == ParallelSNLDA.UNASSIGNED_TOPIC) { continue; }
		...
		for (int position = 0; position < docLength; position++) {
			...
			if (oldTopic != ParallelSNLDA.UNASSIGNED_TOPIC) {
			...
			boolean alreadyDecremented = (oldTopic == ParallelSNLDA.UNASSIGNED_TOPIC);
