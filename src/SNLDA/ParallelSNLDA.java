...
public class ParallelSNLDA implements Serializable {

	public static final int UNASSIGNED_TOPIC = -1;

	public static Logger logger = MalletLogger.getLogger(ParallelSNLDA.class.getName());
	...
	public ParallelSNLDA (int numberOfTopics) {
		this (numberOfTopics, numberOfTopics, DEFAULT_BETA);
	}
	
	public ParallelSNLDA (int numberOfTopics, double alphaSum, double beta) {
	...
	public ParallelSNLDA (LabelAlphabet topicAlphabet, double alphaSum, double beta) {
	...
	public void sumTypeTopicCounts (WorkerRunnableSNLDA[] runnables) {
	...
	public void optimizeAlpha(WorkerRunnableSNLDA[] runnables) {
	...
	public void temperAlpha(WorkerRunnableSNLDA[] runnables) {
	...
	public void optimizeBeta(WorkerRunnableSNLDA[] runnables) {
	...
	public void estimate () throws IOException {
		...
		WorkerRunnableSNLDA[] runnables = new WorkerRunnableSNLDA[numThreads];
		...
		if (numThreads > 1) {
			...
			for (int thread = 0; thread < numThreads; thread++) {
				...
				runnables[thread] = new WorkerRunnableSNLDA(numTopics,
													   alpha, alphaSum, beta,
													   random, data,
			...
			runnables[0] = new WorkerRunnableSNLDA(numTopics,
											  alpha, alphaSum, beta,
											  random, data,
	...
	public static ParallelSNLDA read (File f) throws Exception {

		ParallelSNLDA topicModel = null;

		ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
		topicModel = (ParallelSNLDA) ois.readObject();
		ois.close();
	...
	public static void main (String[] args) {
		...
		try {
			...
			ParallelSNLDA lda = new ParallelSNLDA (numTopics, 50.0, 0.01);
